    ...
    return (
        <div id="carouselExampleIndicatorsheader" className="carousel slide"  data-ride="carousel" >
            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-item">
                    <img src="https://a0.muscache.com/im/pictures/23a937f1-cdf2-4e05-8ac6-6a66135aee82.jpg" className="d-block w-100" alt="Comfortable Bedroom" />
                </div>
            </div>
            <a className="carousel-control-prev" href="#carouselExampleIndicatorsheader" role="button" data-slide="prev">
                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                <span className="sr-only">Previous</span>
            </a>
            <a className="carousel-control-next" href="#carouselExampleIndicatorsheader" role="button" data-slide="next">
